...
describe('favorite blogs', () => {
  ...
  test('of a bigger list should return the correct value', () => {
...
describe('mostBlogs', () => {
  ...
  test('in a larger list should return the correct value', () => {
    const expect = {
      author: 'Robert C. Martin',
      blogs: 3,
    };
    assert.deepStrictEqual(listHelper.mostBlogs(blogs), expect);
  });
});
...
describe('mostLikes', () => {
  ...
  test('most likes should return the expected valus', () => {
